...
> **Historical snapshot.** Moved unchanged from `docs/validation.md` at source `db92311`
> (relative links adjusted). It is not current status; see [STATUS.md](../../STATUS.md).

[Project overview](../../README.md) · [Implementation boundaries](../../IMPLEMENTATION.md) · [Deployment checklist](2026-09-20-live-deployment-checklist.md)
...
checks and the [historical core report](2026-09-19-phase-2-verification.md) for the earlier
277-test milestone.
