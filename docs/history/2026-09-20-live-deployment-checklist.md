...
> **Historical snapshot.** Moved unchanged from `docs/live-deployment-plan.md` at source `db92311`
> (relative links adjusted). It is not current status; see [STATUS.md](../../STATUS.md).

[Project overview](../../README.md) · [Validation status](2026-09-20-validation-status.md) · [GPU procedure](../gpu-deployment.md)
...
The operator's retained evidence is named in [validation status](2026-09-20-validation-status.md).
